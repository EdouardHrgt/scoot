  ...
  <footer class="flex items-center bg-very-dark px-24 max-[900px]:px-6 py-9 max-[900px]:flex-col max-[900px]:gap-12 max-[900px]:py-16">
    <router-link to="/" class="h-fit mr-10">
      <svg
        ...
        width="110"
        height="29"
        class="hover:fill-yellow fill-white ease-in duration-200 cursor-pointer max-[900px]:ml-7"
      >
        <path
    ...
    <nav class="gap-6 max-[900px]:flex-col max-[900px]:flex max-[900px]:items-center max-[900px]:w-full">
      <RouterLink
        to="/about"
        class="text-dim-grey css-body px-3 hover:text-yellow ease-in duration-200"
    ...
    <div class="socials flex items-center gap-6 ml-auto max-[900px]:ml-0 max-[900px]:mt-8">
      <a href="#">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          class="fill-yellow hover:fill-snow ease-in duration-200 cursor-pointer"
        >
          <path
