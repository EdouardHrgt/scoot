...
<template>
  <section>
    ...
    <ArticleRight :isBtn="true" :index="3" />
    <BubbleList title="Why join us?" />
    <SignUp />
    <Footer />
  </section>
  <!-- About Location Careers Get Scootin Careers Care to join our mission? We’re always looking for ambitious individuals
    ...
    urban living we want to hear from you! Say Hello Why join us? 01 Our tech We’re using cutting edge technology to
    ...
    are Scoot employees. General Manager Jakarta, Indonesia Apply UI/UX Designer Yokohama, Japan Apply Blog Content
    Copywriter New York, United States Apply Graphic Designer New York, United States Apply Fleet Supervisor Jakarta,
    Indonesia Apply UX Analyst London, United Kingdom Apply Sign up and Scoot off today About Location Careers -->
</template>
